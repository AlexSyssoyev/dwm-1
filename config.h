...
static Key keys[] = {
	...
	{ MODKEY,			XK_dead_acute,	spawn,		SHCMD("pamixer --allow-boost -d 5; kill -44 $(pidof dwmblocks)") },
	...
	{ MODKEY|ShiftMask,		XK_braceright,		spawn,		SHCMD("mpc seek +60") },
	...
	{ MODKEY,			XK_c,		spawn,		SHCMD("dmenuhandler") },
	{ MODKEY|ShiftMask,		XK_c,		spawn,		SHCMD("cliptompv") },
	//{ MODKEY,			XK_v,		spawn,		SHCMD() },
	{ MODKEY,			XK_less,	spawn,		SHCMD("toggle audio; pkill -RTMIN+13 dwmblocks ") },
...
//{ MODKEY,			XK_F11,		spawn,		SHCMD("setbg ~/Wallpapers/wallpapers") },
	{ MODKEY,			XK_F11,		spawn,		SHCMD("ranbg") },
//{ MODKEY,			XK_F12,		xrdb,		{.v = NULL } },
	...
	{ 0, XF86XK_AudioRaiseVolume,	spawn,		SHCMD("pamixer --sink alsa_output.pci-0000_00_14.2.output_analog-stereo --allow-boost -i 5; kill -44 $(pidof dwmblocks)") },
	{ 0, XF86XK_AudioLowerVolume,	spawn,		SHCMD("pamixer --sink alsa_output.pci-0000_00_14.2.output_analog-stereo --allow-boost -d 5; kill -44 $(pidof dwmblocks)") },
